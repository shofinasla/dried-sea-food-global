...
export const STRATEGIC_PARTNERS: StrategicPartner[] = [
  {
    ...
    category: 'Regulator & Karantina Ikan',
  ...
  {
    id: 'halal-bpjph',
    name: 'Halal Indonesia (BPJPH Kemenag)',
    category: 'Sertifikasi Kehalalan Pangan',
  ...
  },
  {
    ...
    category: 'Fasilitasi Ekspor & Perdagangan',
  ...
  {
    id: 'inaexport',
    name: 'InaExport (Kemendag RI)',
    category: 'Direktori Eksportir Terverifikasi',
  ...
  {
    id: 'kemenkumham',
    name: 'Kemenkumham Republik Indonesia',

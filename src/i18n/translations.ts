...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationSchema> = {
  en: {
    ...
    nav: {
      ...
      requestRfqBtn: 'Request Trade Quote',
      hotline24h: 'Trade Hotline 24/7:',
      adminOpen: 'Open Admin Management Portal'
    },
    hero: {
      badge: 'INDONESIAN DRIED SEAFOOD',
      titlePart1: 'Dried Seafood',
      titleHighlight: 'from Indonesia,',
      titlePart2: 'for Global Markets.',
      description: 'Direct B2B exporter of premium dried fish, salted anchovies, dried squid, and fish maw. Sourced sustainably from Indonesian coastal fisheries with standardized moisture control, zero chemical additives, and official quarantine clearance.',
      ...
      statVolume: '350+ MT',
      statVolumeLabel: 'Annual Supply Volume',
    ...
    about: {
      badge: 'PREMIUM QUALITY HERITAGE',
      ...
      pillar4Title: 'Specialized Product Packaging',
    ...
    products: {
      ...
      title: 'Premium Dried Fish & Seafood Selection',
      ...
      specPackaging: 'Product Packaging',
      specHsCode: 'HS Code',
    ...
    workflow: {
      ...
      title: 'Seamless Trade Process from Harbour to Destination Port',
      subtitle: 'Our experienced trade team manages procurement, quality inspection, documentation, customs clearance, and global logistics.',
      ...
      step5Desc: 'Containers loaded at Jakarta (Tanjung Priok), Belawan, or Surabaya, or air-shipped via Soekarno-Hatta (CGK). Full BL and shipping docs sent for prompt clearance.'
    },
    calculator: {
    ...
    gallery: {
      ...
      subtitle: 'Explore high-resolution visual evidence of our sanitary solar drying domes, cold storage facilities, grading tables, and container operations.',
      ...
      filterShipping: 'Container Stuffing',
      filterSustainability: 'Fishermen Empowerment'
    },
    map: {
      badge: 'GLOBAL REACH & PROCESSING NETWORK',
      title: 'Strategic Production Hubs & International Trade Routes',
      ...
      headquartersTitle: 'Corporate HQ & Trade Office',
    ...
    faq: {
      ...
      title: 'Trade Compliance, Minimum Orders & Payment Terms',
      ...
      a1: 'We provide complete trade documentation: Health Certificate from BKIPM (Indonesian Ministry of Marine Affairs & Fisheries), Certificate of Origin (COO / Form D/AK/E), Commercial Invoice, Packing List, Certificate of Analysis (COA), Bill of Lading (BL) / Air Waybill (AWB), and Fumigation certificate if required.',
    ...
    contact: {
      badge: 'INSTANT TRADE QUOTATION',
      title: 'Request a Formal Product Price Quote (RFQ)',
      subtitle: 'Send us your commodity specifications, volume requirement, and destination port. Our trade managers will respond with FOB/CIF quotation within 4-12 hours.',
      ...
      submitBtn: 'Submit Trade Inquiry (SSL Encrypted)',
      sending: 'Submitting Inquiry Securely...',
      successMessage: 'Thank you! Your RFQ has been received and routed to our Senior Trade Specialist. A formal quotation will be sent to your email shortly.',
      sslNote: 'Protected by TLS 1.3 256-bit encryption. Your commercial data is strictly confidential.'
    },
    footer: {
      tagline: 'Leading Indonesian supplier of premium dried seafood, salted fish, dried squid, and fish maw. Certified HACCP Grade A and BKIPM Quarantine compliant.',
      addressLabel: 'Main Trade Terminal & HQ',
      hotlineLabel: '24/7 International Desk',
      emailLabel: 'Commercial RFQ Desk',
      quickLinks: 'Commercial Sections',
      compliance: 'Trade Standards & Certifications',
      ...
      description: 'Official supplier of premium Indonesian dried marine products and salted fish. Connecting Indonesian archipelagic wealth to international buyers with HACCP hygiene standards, chemical-free processing, and official quarantine clearance.',
      productsTitle: 'Product Commodities & Services',
  ...
  id: {
    ...
    hero: {
      badge: 'HASIL LAUT KERING INDONESIA',
      titlePart1: 'Hasil Laut Kering',
      titleHighlight: 'dari Indonesia,',
      titlePart2: 'untuk Pasar Global.',
      description: 'Eksportir B2B hasil laut kering, ikan asin premium, teri nasi, cumi kering, dan gelembung ikan. Dipasok langsung dari sentra nelayan pesisir Indonesia dengan kadar air terstandarisasi, 100% bebas formalin, dan sertifikasi karantina resmi.',
      ctaRfq: 'Minta Penawaran (RFQ)',
    ...
    contact: {
      ...
      successMessage: 'Terima kasih! Permintaan penawaran (RFQ) Anda telah terenkripsi dan diteruskan ke Senior Trade Specialist kami. Penawaran resmi akan dikirim ke email Anda dalam hitungan jam.',

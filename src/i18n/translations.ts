...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationSchema> = {
  en: {
    ...
    hero: {
      badge: 'INDONESIA SEAFOOD SUPPLIER OF EXCELLENCE',
      titlePart1: 'Premium Indonesian',
      titleHighlight: 'Dried Seafood & Fish',
      titlePart2: 'For Global Markets',
      description: 'Direct supplier of Grade AAA Indonesian dried anchovy (teri nasi/whitebait), salted kurisi & jambal roti, sun-dried squid, and premium fish maw. Produced with closed Solar Dome drying technology, strictly zero chemical preservatives, compliant with HACCP and international SPS quarantine standards.',
      ctaRfq: 'Request Formal RFQ',
      ctaCatalog: 'Download Product Catalog (PDF)',
